...
# Read DB URL from env var; override the ini value so alembic.ini needs no hardcoded URL
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql+asyncpg://mcfd:mcfd@localhost:5432/mcfd")
